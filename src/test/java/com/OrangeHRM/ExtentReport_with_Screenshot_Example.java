...
public class ExtentReport_with_Screenshot_Example {
	...
	public void startReport(){
		 ...
		 * "/Screenshot_Failure/"+screenshotName+dateName+".png"; File finalDestination
	...
	public void getResult(ITestResult result) throws Exception{
		if(result.getStatus() == ITestResult.FAILURE){
            ...
            //String screenshotPath = ExtentReport_with_Screenshot_Example.getScreenhot(driver, result.getName());
